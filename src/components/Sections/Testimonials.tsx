...
const Testimonials: FC<TestimonialsProps> = memo(({ fullWidth }) => {
  ...
  return (
    <Section fullWidth={fullWidth} noPadding sectionId={SectionId.Testimonials}>
      <div
...
const Testimonial: FC<{ testimonial: Testimonial; isActive: boolean }> = memo(
  ({ testimonial: { text, name, image }, isActive }) => (
    <div
      className={classNames(
        'flex w-full shrink-0 snap-start snap-always flex-col items-center gap-y-4 p-2 transition-opacity duration-1000 sm:flex-row sm:gap-x-6',
