...
interface HashnodeIconProps extends React.HTMLAttributes<SVGSVGElement> {
  svgRef?: React.Ref<SVGSVGElement>;
  transform?: string;
}

const HashnodeIcon: FC<HashnodeIconProps> = memo(props => (
  <svg {...props} fill="none" height="337" viewBox="0 0 337 337" width="337">
    <path
      clipRule="evenodd"
